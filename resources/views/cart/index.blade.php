     ...
     <li class="list-group-item py-3">
       <div class="row g-3">
         <div class="col-4 col-md-3 col-lg-2">
           <a href="#">
             <img src="https://www.lojatenisbranco.com.br/image/cache/catalog/jordan%20retro/Nike%20Air%20Jordan%20Branco%20Vermelho%20-%201-800x800.png" alt="" class="img-thumbnail">
           </a>
         </div>
         ...
         <div class="col-6 offset-6 col-sm-6 offtset-sm-6 col-md-4 offset-md-8 col-lg-3 offset-lg-0 col-xl-2 align-self-center mt-3">
           ...
           <div class="text-right mt-2">
             ...
             <p class="text-dark">Valor: R$ 157,99</p>
           </div>
         </div>
       </div>
     </li>
